...
class Product(BaseModel):
    ...
    price = models.DecimalField(max_digits=10 ,decimal_places =0,verbose_name="产品价格",null=True,blank=True)
    vip_price = models.DecimalField(max_digits=10,decimal_places=0,verbose_name="产品优惠价格",null=True,blank=True)
