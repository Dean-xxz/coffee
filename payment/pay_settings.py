...
WECHAT_PAY_CONFIG = {
    ...
    'notify_url':"http://www.xlxhs.cn:5555/payment/notify"
}
...
ALI_PAY_CONFIG = {
    ...
    'alipay_notify_url':"http://www.xlxhs.cn:5555/payment/notify/",  # 交易过程中服务器异步通知的页面 要用 http://格式的完整路径，不允许加?id=123这类自定义参数
    'alipay_show_url':'',
